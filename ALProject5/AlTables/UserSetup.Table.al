table 91 "User Setup"
{
    ...
    fields
    {
        ...
        field(5901; "View Payroll"; Boolean)
        {
            DataClassification = ToBeClassified;
        }
        field(5902; "Edit loans"; Boolean)
        {
            DataClassification = ToBeClassified;
        }
        field(5903; "is Hr"; Boolean)
        {
            DataClassification = ToBeClassified;
        }
        field(5904; "Post Requisition"; Boolean)
        {
            DataClassification = ToBeClassified;
        }
        field(5905; "Global Dimension 1 Code"; Code[20])
        {
            CaptionClass = '1,1,1';
            DataClassification = ToBeClassified;
            TableRelation = "Dimension Value".Code WHERE ("Global Dimension No." = CONST (1));
        }
        field(5906; tetst; Code[20])
        {
            CaptionClass = '1,2,2';
        ...
        field(5907; "Shortcut Dimension 3 Code"; Code[20])
        {
            CaptionClass = '1,2,3';
        ...
        field(5908; "Shortcut Dimension 4 Code"; Code[20])
        {
            CaptionClass = '1,2,4';
        ...
        field(5909; "Post Stores Requisition"; Boolean)
        {
            DataClassification = ToBeClassified;
        }
        field(5910; "Cancel Requisition"; Boolean)
        {
            DataClassification = ToBeClassified;
        }
        field(5911; CanEditPayDetails; Boolean)
        {
            DataClassification = ToBeClassified;
        }
    }
