table 27 Item
{
    ...
    fields
    {
        ...
        field(67; "Location Filter"; Code[50])
        {
        ...
        field(5424; "Variant Filter"; Code[23])
        {
        ...
        field(8006; "Inventory Levels"; Decimal)
        {
            CalcFormula = Sum ("Item Ledger Entry".Quantity WHERE ("Item No." = FIELD ("No."),
                                                                  "Location Code" = FIELD ("Location Filter"),
                                                                  "Transferr to Base Station" = FILTER (false),
                                                                  "Recovered Functional" = FILTER (false),
                                                                  "Recovered Faulty" = FILTER (false)));
            Caption = 'Inventory';
            DecimalPlaces = 0 : 5;
            Editable = false;
            FieldClass = FlowField;
        }
        field(8007; "Recovered Functional"; Decimal)
        {
            CalcFormula = Sum ("Item Ledger Entry".Quantity WHERE ("Item No." = FIELD ("No."),
                                                                  "Location Code" = FIELD ("Location Filter"),
                                                                  "Recovered Functional" = FILTER (true)));
            DecimalPlaces = 0 : 5;
            FieldClass = FlowField;
        }
        field(8008; "Recovered Faulty"; Decimal)
        {
            CalcFormula = Sum ("Item Ledger Entry".Quantity WHERE ("Item No." = FIELD ("No."),
                                                                  "Location Code" = FIELD ("Location Filter"),
                                                                  "Recovered Faulty" = FILTER (true)));
            DecimalPlaces = 0 : 5;
            FieldClass = FlowField;
        }
        ...
        field(99008501; "Item G/L Budget Account"; Code[20])
        {
            DataClassification = ToBeClassified;
            TableRelation = "G/L Account"."No.";
        }
        field(99008502; TEXT; Code[35])
        {
            DataClassification = ToBeClassified;
        }
        field(99008503; "TET."; Code[35])
        {
            DataClassification = ToBeClassified;
        }
        field(99008504; "is Consumable"; Boolean)
        {
            DataClassification = ToBeClassified;
        }
        field(99008505; "Class Code"; Code[30])
        {
            DataClassification = ToBeClassified;
            TableRelation = "FA Class".Code;
        }
        field(99008506; "Sub Class Code"; Code[30])
        {
            DataClassification = ToBeClassified;
            TableRelation = "FA Subclass".Code;
        }
        field(99008507; Display; Boolean)
        {
            DataClassification = ToBeClassified;
            ...
            begin
                ...
                if itemLedger.Find('-') then begin
                    repeat
                        itemLedger.Display := Display;
                        itemLedger.Modify;
                    until itemLedger.Next = 0;
                    Message('Ledger Enteties updated');
                end;
            end;
        }
        field(99008508; NEW; Decimal)
        {
            CalcFormula = Sum ("Item Ledger Entry".Quantity WHERE ("Item No." = FIELD ("No."),
                                                                  "Location Code" = FIELD ("Location Filter"),
                                                                  "Variant Code" = FILTER ('NEW')));
            FieldClass = FlowField;
        }
        field(99008509; USED; Decimal)
        {
            CalcFormula = Sum ("Item Ledger Entry".Quantity WHERE ("Item No." = FIELD ("No."),
                                                                  "Location Code" = FIELD ("Location Filter"),
                                                                  "Variant Code" = FILTER ('USED')));
            FieldClass = FlowField;
        }
        field(99008510; "Installations Today"; Decimal)
        {
            CalcFormula = - Sum ("Item Ledger Entry".Quantity WHERE ("Item No." = FIELD ("No."),
                                                                   "Posting Date" = FIELD ("Date Filter"),
                                                                   Quantity = FILTER (< 0)));
        ...
        field(99008511; WareHouse; Decimal)
        {
            CalcFormula = Sum ("Item Ledger Entry".Quantity WHERE ("Item No." = FIELD ("No."),
                                                                  "Location Code" = CONST ('NANYUKI')));
            FieldClass = FlowField;
        }
    }
