table 32 "Item Ledger Entry"
{
    ...
    fields
    {
        ...
        field(6603; "Posting Time"; Time)
        {
            DataClassification = ToBeClassified;
        }
        field(6604; "Recovered Functional"; Boolean)
        {
            DataClassification = ToBeClassified;
        }
        field(6605; "Recovered Faulty"; Boolean)
        {
            DataClassification = ToBeClassified;
        }
        field(6606; "Uploaded By"; Code[40])
        {
            DataClassification = ToBeClassified;
        }
        field(6607; "Uploaded Through Asset Module"; Boolean)
        {
            DataClassification = ToBeClassified;
        }
        field(6608; "Transferr to Base Station"; Boolean)
        {
            DataClassification = ToBeClassified;
        }
        field(6609; "Technician Assigned"; Code[60])
        {
            DataClassification = ToBeClassified;
        }
        field(6610; "Asset State"; Option)
        {
            DataClassification = ToBeClassified;
            OptionCaption = 'Open,Installed,Damaged,Lost,Returned,Found,Undamaged';
            OptionMembers = Open,Installed,Damaged,Lost,Returned,Found,Undamaged;
        }
        field(6611; "Customer No"; Code[100])
        {
            DataClassification = ToBeClassified;
        ...
        field(6612; "Customer Name"; Code[100])
        {
            DataClassification = ToBeClassified;
        }
        field(6613; "Installation Date"; Date)
        {
            DataClassification = ToBeClassified;
        }
        field(6614; "Installation Time"; Time)
        {
            DataClassification = ToBeClassified;
        }
        field(6615; Display; Boolean)
        {
            DataClassification = ToBeClassified;
        }
        field(6616; "Repeated Serial"; Boolean)
        {
            DataClassification = ToBeClassified;
        }
    }
