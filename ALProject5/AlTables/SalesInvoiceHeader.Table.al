table 112 "Sales Invoice Header"
{
    ...
    fields
    {
        ...
        field(8002; "ESD Signature 2"; Text[77])
        {
            DataClassification = ToBeClassified;
        }
        field(10000; "Number of Hours"; Decimal)
        {
            DataClassification = ToBeClassified;
        }
        field(50000; "Customer Email Address"; Text[80])
        {
            CalcFormula = Lookup (Customer."E-Mail" WHERE ("No." = FIELD ("Sell-to Customer No.")));
            FieldClass = FlowField;
        }
        field(50001; "ESD Signature"; Text[77])
        {
            DataClassification = ToBeClassified;
        }
        field(50002; "ESD Processed"; Boolean)
        {
            DataClassification = ToBeClassified;
        }
        field(50003; cu_invoice_number; Text[77])
        {
            DataClassification = ToBeClassified;
        }
        ...
        {
            DataClassification = ToBeClassified;
            OptionCaption = ' ,New,Recurrent,winback';
            OptionMembers = " ",New,Recurrent,winback;
        }
        field(50005; "QR Code"; BLOB)
        {
            DataClassification = ToBeClassified;
            SubType = Bitmap;
        }
        field(50006; SignatureImage; BLOB)
        {
            DataClassification = ToBeClassified;
        }
        field(50007; "KRA Url"; Text[250])
        {
            DataClassification = ToBeClassified;
        }
        field(50008; "Code Generated"; Boolean)
        {
            DataClassification = ToBeClassified;
        }
    }
