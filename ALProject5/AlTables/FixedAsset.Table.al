table 5600 "Fixed Asset"
{
    ...
    fields
    {
        ...
        field(141; "Customer No."; Code[100])
        {
        ...
        field(142; "Date Created"; Date)
        {
            DataClassification = ToBeClassified;
        }
        field(143; Recovered; Boolean)
        {
            DataClassification = ToBeClassified;
        }
        field(144; "Recovery Type"; Option)
        {
            DataClassification = ToBeClassified;
            OptionMembers = Normal,Lost,Damaged;
        }
        field(145; "Customer Name"; Code[70])
        {
            DataClassification = ToBeClassified;
        }
    }
