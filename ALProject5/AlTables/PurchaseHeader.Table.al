table 38 "Purchase Header"
{
    ...
    fields
    {
        ...
        field(3; "No."; Code[20])
        {
            ...
            begin
                ...
                if (PR = false) and ("Document Type" = "Document Type"::Quote) then begin
                    PurchSetup1.Get();
                    if "No." <> xRec."No." then begin
                        PurchSetup1.Get;
                        NoSeriesMgt.TestManual(PurchSetup1."Purchase Quotes");
                        "No. Series" := '';
                    end;
                end;
                ...
                if ("Document Type" = "Document Type"::Quote) then begin
                    ...
                    if "No." <> xRec."No." then begin
                        PurchSetup1.Get;
                        NoSeriesMgt.TestManual(PurchSetup1."Order Nos.");
                        "No. Series" := '';
                    end;
                end;
                ...
                if ("Document Type" = "Document Type"::Invoice) then begin
                    ...
                    if "No." <> xRec."No." then begin
                        PurchSetup1.Get;
                        NoSeriesMgt.TestManual(PurchSetup1."Invoice Nos.");
                        "No. Series" := '';
                    end;
                end;
                ...
                if ("Document Type" = "Document Type"::"Credit Memo") then begin
                    ...
                    if "No." <> xRec."No." then begin
                        PurchSetup1.Get;
                        NoSeriesMgt.TestManual(PurchSetup1."Credit Memo Nos.");
                        "No. Series" := '';
                    end;
                end
            end;
        ...
        field(57; Receive; Boolean)
        {
            ...
            begin
                ...
                usersetup.SetFilter(usersetup."User ID", 'MERCY MWANIKI');
                if usersetup.Find('-') then
                    if (Receive = true) and ("Document Type" = "Document Type"::Order) then begin
                        Emailmessage := 'Dear ' + UserId + ', LPO of ' + "No." + 'Has been received. ';
                        SMTPMailSetup.Get;
                        SMTPMail.CreateMessage('requisitions@mawingu.co', 'requisitions@mawingu.co', usersetup."E-Mail", 'LPO Received', Emailmessage, true);
                        SMTPMail.AddCC('ops@mawingu.co');
                        SMTPMail.SendCustom('requisitions@mawingu.co', 'Tat44669');
                    end;
            end;
        }
            ...
            begin
                if Status = Status::Released then begin
                    ...
                    if employee.Get("Staff No") then
                        if DocApprovalType = DocApprovalType::Requisition then
                            doctype := 'Requisition';
                    if ("Document Type" = "Document Type"::Quote) and (DocApprovalType = DocApprovalType::Purchase) then
                        doctype := 'Purchase Quote';
                    if ("Document Type" = "Document Type"::Order) then
                        doctype := 'Purchase Oder';
                    Emailmessage := 'Dear ' + employee.Name + 'your ' + doctype + ' has been approved';
                    SMTPMailSetup.Get;
                    SMTPMail.CreateMessage('requisitions@mawingu.co', 'requisitions@mawingu.co', employee.employee_email, doctype, Emailmessage, true);
                    SMTPMail.AddCC('ops@mawingu.co');
                    SMTPMail.SendCustom('requisitions@mawingu.co', 'Tat44669');
                end;
            end;
        ...
        field(9002; "Responsible Officer"; Code[50])
        {
            DataClassification = ToBeClassified;
            TableRelation = "User Setup";
        }
        field(9003; "Received from (CLient)"; Code[80])
        {
            DataClassification = ToBeClassified;
            TableRelation = Customer;
        }
        field(9004; Narration; Text[80])
        {
            DataClassification = ToBeClassified;
        }
        field(9005; "User ID"; Code[30])
        {
            DataClassification = ToBeClassified;
        }
        field(9006; Completed; Boolean)
        {
            DataClassification = ToBeClassified;
        }
        field(9007; "Procurement Type Code"; Code[20])
        {
            DataClassification = ToBeClassified;
            TableRelation = "Procurement Methods";
        }
        field(9008; "Doc Type"; Option)
        {
            DataClassification = ToBeClassified;
            OptionCaption = ',PurchReq';
            OptionMembers = ,PurchReq;
        }
        field(9009; PR; Boolean)
        {
            DataClassification = ToBeClassified;
        }
        field(9010; DocApprovalType; Option)
        {
            DataClassification = ToBeClassified;
            OptionMembers = Purchase,Requisition,Quote,Capex;
        }
        field(9011; "RFQ No."; Code[20])
        {
            DataClassification = ToBeClassified;
            ...
            begin
                ...
                if PAGE.RunModal(50594, RFQHdr) = ACTION::LookupOK then
                    InsertRFQ(RFQHdr);
            end;
        }
        field(9012; "Quote No"; Code[25])
        {
            DataClassification = ToBeClassified;
            ...
            trigger OnLookup()
            var
                RFQLines: Record "Purchase Line";
                ReqLines: Record "Purchase Line";
                RQLINES: Record "Purchase Line";
            begin

                PHeader.SetRange(PHeader.Status, PHeader.Status::Released);
                if PAGE.RunModal(9306, PHeader) = ACTION::LookupOK then
                    InsertPorder(PHeader);
                // ReqLines.RESET;
                // ReqLines.SETRANGE(ReqLines."Document Type", ReqLines."Document Type"::Order);
                ...
                //
                // //RQLINES.RESET;
                // RQLINES.SETRANGE(RQLINES."Document No.",PHeader."No.");
                // RQLINES.SETRANGE(RQLINES."Document Type",RQLINES."Document Type"::Quote);
                // IF RQLINES.FINDSET THEN BEGIN
                // lineno:=0;
                //   REPEAT
                ...
                //  ReqLines."Document Type":= ReqLines."Document Type"::Order;
                //  ReqLines."Document No.":= "No.";
                //  ReqLines.Type:=RQLINES.Type;
                //  ReqLines."No.":=RQLINES."No.";
                //   MESSAGE('item no %1', RQLINES."No.");
                //  ReqLines."Location Code":=RQLINES."Location Code";
                //  ReqLines."Posting Group":=RQLINES."Posting Group";
                //  ReqLines."Expected Receipt Date":=RQLINES."Expected Receipt Date";
                //  ReqLines.Description:=RQLINES.Description;
                //  ReqLines."Unit of Measure Code":=RQLINES."Unit of Measure Code";
                //  ReqLines."Line No.":=lineno;
                ...
                //    ReqLines."Unit of Measure Code":=RQLINES."Unit of Measure Code";
                //
                //  ReqLines."Direct Unit Cost":=RQLINES."Direct Unit Cost";
                //
                //  //ReqLines.MODIFY;
                // //END;
                ...
                // MODIFY;
                bidding.Reset;
                bidding.SetRange(bidding."Quote No.", "Quote No");
                if bidding.Find('-') then begin
                    leastbidder.CalcFields(leastbidder."Total Quoted");
                    leastbidder.Reset;
                    leastbidder.SetRange(leastbidder."RFQ No.", bidding."RFQ No.");
                    leastbidder.SetCurrentKey(leastbidder."Total Quoted");
                    if leastbidder.FindFirst then
                        "Preffered Vendor" := leastbidder."Vendor No.";
                end;
            end;
        ...
        field(9013; "Preffered Vendor"; Code[25])
        {
            DataClassification = ToBeClassified;
        }
        field(9014; "Reason not awarding preffered"; Code[200])
        {
            DataClassification = ToBeClassified;
        }
        field(9015; "Staff No"; Code[25])
        {
            DataClassification = ToBeClassified;
    ...
    var
        StandardCodesMgt: Codeunit "Standard Codes Mgt.";
    begin
        //MESSAGE('Doc type is %1',"Document Type");
        if (PR = true) then
            InitInsert;
        ...
        if (PR = false) and ("Document Type" = "Document Type"::Quote) then begin
            if "No." = '' then begin
                PurchSetup1.Get;
                PurchSetup1.TestField(PurchSetup1."Purchase Quotes");
                NoSeriesMgt.InitSeries(PurchSetup1."Purchase Quotes", xRec."No. Series", 0D, "No.", "No. Series");
            end;
        end;
        if ("Document Type" = "Document Type"::Order) then begin
            if "No." = '' then begin
                PurchSetup1.Get;
                PurchSetup1.TestField(PurchSetup1."Order Nos.");
                NoSeriesMgt.InitSeries(PurchSetup1."Order Nos.", xRec."No. Series", 0D, "No.", "No. Series");
            end;
        ...
        if ("Document Type" = "Document Type"::Invoice) then begin
            if "No." = '' then begin
                PurchSetup1.Get;
                PurchSetup1.TestField(PurchSetup1."Invoice Nos.");
                NoSeriesMgt.InitSeries(PurchSetup1."Invoice Nos.", xRec."No. Series", 0D, "No.", "No. Series");
            end;
        end;
        ...
        if ("Document Type" = "Document Type"::"Credit Memo") then begin
            if "No." = '' then begin
                PurchSetup1.Get;
                PurchSetup1.TestField(PurchSetup1."Credit Memo Nos.");
                NoSeriesMgt.InitSeries(PurchSetup1."Credit Memo Nos.", xRec."No. Series", 0D, "No.", "No. Series");
                "Posting No. Series" := 'P-CR+';
            end;
        end;
    end;
    ...
    var
        ...
        bidding: Record "Bid Analysis";
        leastbidder: Record "Bid Analysis";
        usersetup: Record "User Setup";
    ...
    begin
        ...
        if DocApprovalType = DocApprovalType::Requisition then
            "Posting Description" := Format(DocApprovalType) + ' ' + "No.";
        UpdateInboundWhseHandlingTime;
    ...
    begin
        ...
        if RFQLines.FindSet then
            repeat
                ...
                // ReqLines.VALIDATE(ReqLines."Unit of Measure Code");
                ReqLines."Buy-from Vendor No." := "Buy-from Vendor No.";
                ReqLines."Pay-to Vendor No." := "Pay-to Vendor No.";
                ...
                ReqLines.Validate(ReqLines.Quantity);
                ReqLines.Validate(ReqLines."Direct Unit Cost");
                ReqLines."Unit of Measure Code" := RFQLines."Unit of Measure";
    ...
    [Scope('Internal')]
    procedure InsertPorder(var Pheader: Record "Purchase Header")
    var
        ReqLines: Record "Purchase Line";
        RFQLines: Record "Purchase Line";
    begin
        ...
        RFQLines.SetRange(RFQLines."Document No.", Pheader."No.");
        RFQLines.SetRange(RFQLines."Document Type", RFQLines."Document Type"::Quote);
        if RFQLines.FindSet then
            lineno := 0;
        repeat
            lineno := lineno + 1000;
            ReqLines.Init;
            ReqLines.Type := ReqLines.Type::Item;
            //  ReqLines.TRANSFERFIELDS(RFQLines);
            ReqLines."Document Type" := ReqLines."Document Type"::Order;
            ReqLines."Document No." := "No.";
            ...
            ReqLines.Validate(ReqLines."No.");
            ReqLines."Line No." := lineno;
            // MESSAGE('item no %1', RFQLines."No.");
            ReqLines."Location Code" := RFQLines."Location Code";
            ReqLines.Description := RFQLines.Description;
            ReqLines."Posting Group" := RFQLines."Posting Group";
            //  ReqLines."Expected Receipt Date":=RQLINES."Expected Receipt Date";
            //  ReqLines.Description:=RQLINES.Description;
            ReqLines."Unit of Measure Code" := RFQLines."Unit of Measure Code";
            ReqLines."Line No." := lineno;
            //ReqLines.VALIDATE(ReqLines."Unit of Measure Code");
            ReqLines."Buy-from Vendor No." := "Buy-from Vendor No.";
            ReqLines."Pay-to Vendor No." := "Pay-to Vendor No.";
            ReqLines.Insert;
            //MESSAGE('req is %1',ReqLines."No.");
            // //ReqLines.VALIDATE(ReqLines."No.");
            // ReqLines.VALIDATE(ReqLines.Quantity);
            // ReqLines.VALIDATE(ReqLines."Direct Unit Cost");
            //ReqLines."Unit of Measure Code":=RFQLines."Unit of Measure";
