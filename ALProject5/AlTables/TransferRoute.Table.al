table 5742 "Transfer Route"
{
    ...
    fields
    {
        field(1; "Transfer-from Code"; Code[30])
        {
            Caption = 'Transfer-from Code';
            TableRelation = Location WHERE ("Use As In-Transit" = CONST (false));
        }
        field(2; "Transfer-to Code"; Code[30])
        {
            Caption = 'Transfer-to Code';
            TableRelation = Location WHERE ("Use As In-Transit" = CONST (false));
        }
        field(4; "In-Transit Code"; Code[30])
        {
            Caption = 'In-Transit Code';
            TableRelation = Location WHERE ("Use As In-Transit" = CONST (true));
        }
        field(5; "Shipping Agent Code"; Code[30])
        {
        ...
        field(6; "Shipping Agent Service Code"; Code[30])
        {
    ...
    procedure GetTransferRoute(TransferFromCode: Code[30]; TransferToCode: Code[30]; var InTransitCode: Code[30]; var ShippingAgentCode: Code[30]; var ShippingAgentServiceCode: Code[30])
    var
    ...
    procedure CalcReceiptDate(ShipmentDate: Date; var ReceiptDate: Date; ShippingTime: DateFormula; OutboundWhseTime: DateFormula; InboundWhseTime: DateFormula; TransferFromCode: Code[30]; TransferToCode: Code[30]; ShippingAgentCode: Code[30]; ShippingAgentServiceCode: Code[30])
    var
    ...
    local procedure CalcPlanShipmentDateForward(ShipmentDate: Date; var PlannedShipmentDate: Date; OutboundWhseTime: DateFormula; TransferFromCode: Code[30]; ShippingAgentCode: Code[30]; ShippingAgentServiceCode: Code[30])
    begin
        // Calc Planned Shipment Date forward from Shipment Date
    ...
    procedure CalcPlannedReceiptDateForward(PlannedShipmentDate: Date; var PlannedReceiptDate: Date; ShippingTime: DateFormula; TransferToCode: Code[30]; ShippingAgentCode: Code[30]; ShippingAgentServiceCode: Code[30])
    begin
        // Calc Planned Receipt Date forward from Planned Shipment Date
    ...
    procedure CalcReceiptDateForward(PlannedReceiptDate: Date; var ReceiptDate: Date; InboundWhseTime: DateFormula; TransferToCode: Code[30])
    begin
        // Calc Receipt Date forward from Planned Receipt Date
    ...
    procedure CalcShipmentDate(var ShipmentDate: Date; ReceiptDate: Date; ShippingTime: DateFormula; OutboundWhseTime: DateFormula; InboundWhseTime: DateFormula; TransferFromCode: Code[30]; TransferToCode: Code[30]; ShippingAgentCode: Code[30]; ShippingAgentServiceCode: Code[30])
    var
        PlannedReceiptDate: Date;
        PlannedShipmentDate: Date;
    begin
    ...
    procedure CalcPlanReceiptDateBackward(var PlannedReceiptDate: Date; ReceiptDate: Date; InboundWhseTime: DateFormula; TransferToCode: Code[30]; ShippingAgentCode: Code[30]; ShippingAgentServiceCode: Code[30])
    begin
        // Calc Planned Receipt Date backward from ReceiptDate
    ...
    procedure CalcPlanShipmentDateBackward(var PlannedShipmentDate: Date; PlannedReceiptDate: Date; ShippingTime: DateFormula; TransferFromCode: Code[30]; ShippingAgentCode: Code[30]; ShippingAgentServiceCode: Code[30])
    begin
        // Calc Planned Shipment Date backward from Planned ReceiptDate
    ...
    procedure CalcShipmentDateBackward(var ShipmentDate: Date; PlannedShipmentDate: Date; OutboundWhseTime: DateFormula; TransferFromCode: Code[30])
    begin
        // Calc Shipment Date backward from Planned Shipment Date
    ...
    procedure GetShippingTime(TransferFromCode: Code[30]; TransferToCode: Code[30]; ShippingAgentCode: Code[30]; ShippingAgentServiceCode: Code[30]; var ShippingTime: DateFormula)
    begin
