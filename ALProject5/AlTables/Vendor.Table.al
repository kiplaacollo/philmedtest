table 23 Vendor
{
    ...
    fields
    {
        ...
        field(8004; "Secondary Email"; Code[30])
        {
    ...
    [IntegrationEvent(false, false)]
    local procedure OnBeforeValidateShortcutDimCode(var Vendor: Record Vendor; FieldNumber: Integer; var ShortcutDimCode: Code[20]; var IsHandled: Boolean)
    begin
    end;
