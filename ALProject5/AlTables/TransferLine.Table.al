table 5741 "Transfer Line"
{
    ...
    fields
    {
        ...
        field(23; "Unit of Measure Code"; Code[30])
        {
        ...
        field(33; "In-Transit Code"; Code[30])
        {
        ...
        field(36; "Transfer-from Code"; Code[30])
        {
        ...
        field(37; "Transfer-to Code"; Code[30])
        {
        ...
        field(41; "Shipping Agent Code"; Code[30])
        {
        ...
        field(42; "Shipping Agent Service Code"; Code[30])
        {
        ...
        field(5707; "Product Group Code"; Code[30])
        {
    ...
    local procedure GetLocation(LocationCode: Code[30])
    begin
        if Location.Code <> LocationCode then
            Location.Get(LocationCode);
    end;

    local procedure GetBin(LocationCode: Code[30]; BinCode: Code[30])
    begin
        if BinCode = '' then
            Clear(Bin)
        else
    ...
    local procedure GetDefaultBin(FromLocationCode: Code[30]; ToLocationCode: Code[30])
    begin
