table 312 "Purchases & Payables Setup"
{
    ...
    fields
    {
        ...
        field(6603; "Requisition Default Vendor"; Code[30])
        {
        ...
        field(6604; "Quotation Request No"; Code[30])
        {
            DataClassification = ToBeClassified;
            TableRelation = "No. Series";
        }
        field(6605; "Requisition No"; Code[30])
        {
            DataClassification = ToBeClassified;
            TableRelation = "No. Series";
        }
        field(6606; "Purchase Quotes"; Code[30])
        {
            DataClassification = ToBeClassified;
            TableRelation = "No. Series";
        }
        field(6607; "Stores Requisition No"; Code[30])
        {
            DataClassification = ToBeClassified;
            TableRelation = "No. Series";
        }
        field(6608; "Asset Module Nos"; Code[40])
        {
            DataClassification = ToBeClassified;
            TableRelation = "No. Series";
        }
        field(6609; "Customized Serial Nos"; Code[40])
        {
            DataClassification = ToBeClassified;
            TableRelation = "No. Series";
        }
        field(6610; "Asset Transfer Nos"; Code[40])
        {
            DataClassification = ToBeClassified;
            TableRelation = "No. Series";
        }
