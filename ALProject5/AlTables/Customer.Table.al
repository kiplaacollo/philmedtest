table 18 Customer
{
    ...
    fields
    {
        ...
        field(93; "Secondary Phone No."; Text[30])
        {
        ...
        field(50000; "Churn Date"; Date)
        {
            DataClassification = ToBeClassified;
        }
        field(50001; "Suspended from"; Date)
        {
            DataClassification = ToBeClassified;
        }
        field(50002; "Suspended to"; Date)
        {
            DataClassification = ToBeClassified;
        }
        field(50003; "First Invoice Date"; Date)
        {
            CalcFormula = Min ("Cust. Ledger Entry"."Posting Date" WHERE ("Customer No." = FIELD ("No."),
                                                                         "Document Type" = CONST (Invoice)));
            FieldClass = FlowField;
        }
        field(50004; "Invoice No"; Code[30])
        {
            DataClassification = ToBeClassified;
        }
        field(50005; "Invoice Due Date"; Date)
        {
            DataClassification = ToBeClassified;
        }
        field(50006; "Customer Status"; Option)
        {
            DataClassification = ToBeClassified;
            OptionCaption = 'Active,Recovered,Blocked,Merchant,Child Account';
            OptionMembers = Active,Churn,"Not Paid",Merchant,"Child Account";
        }
        field(50007; Deferrals; Option)
        {
            DataClassification = ToBeClassified;
            OptionCaption = 'Deferred 1MO,Deferred 2MO,Deferred 3MO,Deferred 4MO,Deferred 5MO,Deferred 6MO,Deferred 7MO,Deferred 8MO,Deferred 9MO,Deferred 10MO,Deferred 11MO,Deferred 12MO';
            OptionMembers = "1M","2M","3M","4M","5M","6M","7M","8M","9M","10M","11M","12M";
        }
        field(50008; "Total Invoiced"; Decimal)
        {
            CalcFormula = Sum ("Detailed Cust. Ledg. Entry".Amount WHERE ("Customer No." = FIELD ("No."),
                                                                         "Document Type" = CONST (Invoice),
                                                                         "Initial Entry Global Dim. 1" = FIELD ("Global Dimension 1 Filter"),
        ...
        field(50009; "Total Payments"; Decimal)
        {
            CalcFormula = Sum ("Detailed Cust. Ledg. Entry".Amount WHERE ("Customer No." = FIELD ("No."),
        ...
        field(50010; Deffered; Code[50])
        {
            DataClassification = ToBeClassified;
            TableRelation = "Deferral Template"."Deferral Code" WHERE ("Defferal Type" = CONST (Defferal));
        }
        field(50011; "Recurring Package"; Code[50])
        {
            CalcFormula = Lookup ("Standard Customer Sales Code".Code WHERE ("Customer No." = FIELD ("No.")));
            Editable = false;
            FieldClass = FlowField;
        }
        field(50012; "Package Amount Excl VAT"; Decimal)
        {
            CalcFormula = Lookup ("Standard Sales Line"."Amount Excl. VAT" WHERE ("Standard Sales Code" = FIELD ("Recurring Package"),
                                                                                 "No." = CONST ('20101')));
            Editable = false;
            FieldClass = FlowField;
        }
        field(50013; "Package Excise Duty"; Decimal)
        {
            CalcFormula = Lookup ("Standard Sales Line"."Amount Excl. VAT" WHERE ("Standard Sales Code" = FIELD ("Recurring Package"),
                                                                                 "No." = CONST ('14417')));
            FieldClass = FlowField;
        }
        field(50014; "Infrastructure Amount"; Decimal)
        {
            CalcFormula = Sum ("Standard Sales Line"."Amount Excl. VAT" WHERE ("Standard Sales Code" = FIELD ("Recurring Package"),
                                                                              "No." = CONST ('20209')));
            Editable = false;
            FieldClass = FlowField;
        }
        field(50015; "Billing Frequency"; Option)
        {
            DataClassification = ToBeClassified;
            OptionCaption = ' ,1-Month,2-Month,3-Month,4-Month,5-Month,6-Month,7-Month,8-Month,9-Month,10-Month,11-Month,12-Month';
            OptionMembers = " ","1-Month","2-Month","3-Month","4-Month","5-Month","6-Month","7-Month","8-Month","9-Month","10-Month","11-Month","12-Month";
        }
        field(50016; "Disconnection Date"; Date)
        {
            DataClassification = ToBeClassified;
        }
        field(50017; "Receipt No"; Code[30])
        {
            DataClassification = ToBeClassified;
        }
        field(50018; "Receipt Date"; Date)
        {
            DataClassification = ToBeClassified;
        }
        field(50019; "Customer Category"; Option)
        {
            DataClassification = ToBeClassified;
            OptionCaption = ',Max,Biz,EOS,Spots,Impact';
            OptionMembers = " ",HSB,Enterprise,EOS,Merchant,Impact;
        }
        field(50020; "Secondary Email"; Text[50])
        {
            DataClassification = ToBeClassified;
        }
        field(50021; "Total Package Amount"; Decimal)
        {
            CalcFormula = Lookup ("Standard Sales Line"."Amount Excl. VAT" WHERE ("Standard Sales Code" = FIELD ("Recurring Package")));
            FieldClass = FlowField;
        }
        field(50022; "WithHolds Tax"; Boolean)
        {
            DataClassification = ToBeClassified;
        }
        field(50023; "Date Registered"; Date)
        {
            DataClassification = ToBeClassified;
        }
        field(50024; "Splynx ID"; Code[100])
        {
            DataClassification = ToBeClassified;
        }
        field(50025; "Installation Fees"; Decimal)
        {
            CalcFormula = Lookup ("Standard Sales Line"."Amount Excl. VAT" WHERE ("Standard Sales Code" = FIELD ("Recurring Package"),
                                                                                 "No." = CONST ('20201')));
            Editable = false;
        ...
        field(50026; "Old Customer No"; Code[20])
        {
            DataClassification = ToBeClassified;
        }
        field(50027; LeadNUmber; Code[20])
        {
            DataClassification = ToBeClassified;
        }
        field(50028; "Qualified WinBack"; Boolean)
        {
            DataClassification = ToBeClassified;
        }
        field(50029; "Qualified WinBacks Promo"; Boolean)
        {
            DataClassification = ToBeClassified;
        }
        field(50030; "Parent Account No"; Code[20])
        {
            DataClassification = ToBeClassified;
        }
        field(50031; "Ever Promoted"; Boolean)
        {
            DataClassification = ToBeClassified;
        }
        field(50032; InvoiceCount; Integer)
        {
        ...
        field(50033; "Child Accounts Count"; Integer)
        {
            CalcFormula = Count (Customer WHERE ("Parent Account No" = FIELD ("No.")));
            FieldClass = FlowField;
        }
        field(50034; Router; Code[100])
        {
            DataClassification = ToBeClassified;
        }
        field(50035; Sector; Code[100])
        {
            DataClassification = ToBeClassified;
        }
        field(50036; "Splynx Location"; Code[100])
        {
            DataClassification = ToBeClassified;
        }
        field(50037; "Base Station Code"; Code[4])
        {
            DataClassification = ToBeClassified;
        }
        field(50038; Region; Code[100])
        {
            DataClassification = ToBeClassified;
        }
        field(50039; CpeId; Code[10])
        {
            DataClassification = ToBeClassified;
        }
        field(50040; "Don't Remind"; Boolean)
        {
            DataClassification = ToBeClassified;
        }
        field(50041; "Validate customer"; Boolean)
        {
            DataClassification = ToBeClassified;
        }
    }
    ...
    [IntegrationEvent(false, false)]
    local procedure OnBeforeValidateShortcutDimCode(var Customer: Record Customer; FieldNumber: Integer; var ShortcutDimCode: Code[20]; var IsHandled: Boolean)
    begin
    end;
