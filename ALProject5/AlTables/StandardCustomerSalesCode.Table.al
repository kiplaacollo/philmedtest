table 172 "Standard Customer Sales Code"
{
    ...
    fields
    {
        ...
        field(2; "Code"; Code[10])
        {
            ...
            begin
                if Code = '' then
                    exit;
                StdSalesCode.Reset;
                StdSalesCode.SetRange(Code, Code);
                if StdSalesCode.Find('-') then begin
                    Description := StdSalesCode.Description;
                    "Customer Category" := StdSalesCode."Customer Category";
                    ObjCustomer.Reset;
                    ObjCustomer.SetRange("No.", "Customer No.");
                    if ObjCustomer.Find('-') then begin
                        ObjCustomer."Customer Category" := StdSalesCode."Customer Category";
                        ObjCustomer.Modify;
                    end;
                end;
            end;
        ...
        field(19; "Customer Category"; Option)
        {
