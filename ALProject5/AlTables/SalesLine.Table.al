table 37 "Sales Line"
{
    ...
    fields
    {
        ...
        field(1700; "Deferral Code"; Code[10])
        {
            ...
            begin
                ...
                //Included for automation purporse. For default uses the assistedit page trigger
                if "Deferral Automation" = true then
        ...
        field(7011; "Deferral Automation"; Boolean)
        {
    ...
    [IntegrationEvent(false, false)]
    local procedure OnBeforeCheckAssocPurchOrder(var SalesLine: Record "Sales Line"; FieldCaption: Text[250]; var IsHandled: Boolean; xSalesLine: Record "Sales Line")
    begin
    end;
