table 252 "General Posting Setup"
{
    ...
    local procedure OnBeforeGetPurchPrepmtAccount(GeneralPostingSetup: Record "General Posting Setup"; var AccountNo: Code[20]; var IsHandled: Boolean)
    begin
    end;

    [IntegrationEvent(false, false)]
    local procedure OnBeforeGetSalesPrepmtAccount(GeneralPostingSetup: Record "General Posting Setup"; var AccountNo: Code[20]; var IsHandled: Boolean)
    begin
    end;
}
