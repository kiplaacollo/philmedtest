    ...
    fields
    {
        ...
        field(6; "No."; Code[20])
        {
            ...
            IF (Type = CONST (Item),
                                                                                                                                                                                                "Document Type" = FILTER ("Credit Memo" | "Return Order")) Item WHERE (Blocked = CONST (false))
            ELSE
            IF (Type = CONST (Service)) "Service Item"."No.";
            ...
            begin
                ...
                if Type = Type::Service then begin
                    service.Reset;
                    service.SetRange(service."No.", "No.");
        ...
        field(60; "Quantity Received"; Decimal)
        {
            ...
            begin
                ...
                usersetup.SetFilter(usersetup."User ID", 'ALFRED AMOS');
                if usersetup.Find('-') then
                    CftFactory.FnSendMail('', 'Dear ' + UserId + 'LPO of ' + "Order No." + 'with ' + "No." + Description + 'Has been received. ' + Format(Quantity) +
                                          'Items received in ' + "Location Code", 'cmutai@cft.co.ke', "Order No." + 'Has been received');
            end;
        }
        ...
        field(5407; "Unit of Measure Code"; Code[10])
        {
            ...
            TableRelation = IF (Type = CONST (Item),
                                "No." = FILTER (<> '')) "Item Unit of Measure".Code
            ELSE
            "Unit of Measure";
        ...
        field(99000760; Committed; Boolean)
        {
            DataClassification = ToBeClassified;
        }
        field(99000761; "Expense Code"; Code[10])
        {
            DataClassification = ToBeClassified;
        ...
        field(99000762; Remarks; Text[50])
        {
            DataClassification = ToBeClassified;
            Description = 'Added#KVB';
        }
        field(99000763; "RFQ Remarks"; Text[50])
        {
            DataClassification = ToBeClassified;
        }
        field(99000764; "Batch No"; Code[20])
        {
            DataClassification = ToBeClassified;
        }
    }
