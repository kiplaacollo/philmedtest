table 5740 "Transfer Header"
{
    ...
    fields
    {
        ...
        field(2; "Transfer-from Code"; Code[30])
        {
        ...
        field(10; "Trsf.-from Country/Region Code"; Code[50])
        {
        ...
        field(11; "Transfer-to Code"; Code[50])
        {
        ...
        field(19; "Trsf.-to Country/Region Code"; Code[50])
        {
        ...
        field(23; Status; Option)
        {
            Caption = 'Status';
            Editable = true;
            OptionCaption = 'Open,Pending Approval,Cancelled,Approved,Rejected,Posted';
            OptionMembers = Open,"Pending Approval",Cancelled,Approved,Rejected,Posted;
        ...
        field(27; "In-Transit Code"; Code[30])
        {
        ...
        field(34; "Shipping Agent Code"; Code[30])
        {
        ...
        field(35; "Shipping Agent Service Code"; Code[30])
        {
        ...
        field(37; "Shipment Method Code"; Code[30])
        {
            Caption = 'Shipment Method Code';
            TableRelation = "Shipment Method";
        }
        field(47; "Transaction Type"; Code[30])
        {
            Caption = 'Transaction Type';
            TableRelation = "Transaction Type";
        }
        field(48; "Transport Method"; Code[30])
        {
            Caption = 'Transport Method';
            TableRelation = "Transport Method";
        }
        field(59; "Entry/Exit Point"; Code[30])
        {
            Caption = 'Entry/Exit Point';
            TableRelation = "Entry/Exit Point";
        }
        field(63; "Area"; Code[30])
        {
            Caption = 'Area';
            TableRelation = Area;
        }
        field(64; "Transaction Specification"; Code[30])
        {
        ...
        field(5754; "Location Filter"; Code[30])
        {
    ...
    procedure VerifyNoOutboundWhseHandlingOnLocation(LocationCode: Code[50])
    var
        Location: Record Location;
    begin
    ...
    procedure VerifyNoInboundWhseHandlingOnLocation(LocationCode: Code[50])
    var
        Location: Record Location;
    begin
        if not Location.Get(LocationCode) then
