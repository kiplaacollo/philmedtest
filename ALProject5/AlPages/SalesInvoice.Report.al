report 206 "Sales - Invoice"
{
    ...
    dataset
    {
        dataitem("Sales Invoice Header"; "Sales Invoice Header")
        {
            ...
            column(cuinvoicenumber_SalesInvoiceHeader; "Sales Invoice Header".cu_invoice_number)
            {
            }
            column(DisconnecionDateLbl; DisconnecionDateLbl)
            {
            }
                ...
                dataitem(PageLoop; "Integer")
                {
                    ...
                    dataitem("Sales Invoice Line"; "Sales Invoice Line")
                    {
                        ...
                        begin
                            ...
                            lvSalesInvLine.SetRange("Document No.", "Sales Invoice Line"."Document No.");
                            lvSalesInvLine.SetFilter(lvSalesInvLine."No.", '<>%1', '');
                            if lvSalesInvLine.FindLast then
                                LineNoWithTotal := lvSalesInvLine."Line No.";
            ...
            begin
                ...
                //ERROR()dim
                //QRMng.RUN("Sales Invoice Header");
                //QRMng.FnCreatQRCode("Sales Invoice Header");
                "Sales Invoice Header".CalcFields("QR Code");
                if Cust.Get("Bill-to Customer No.") then begin
                    Dimension.Reset;
                    Dimension.SetRange(Dimension."No.", "Sales Invoice Header"."No.");
                    Dimension.SetFilter(Dimension."Dimension Code", 'TOWER');
                    if Dimension.Find('-') then begin
                        Tower := Dimension."Dimension Value Code";
                    end;
                end;
    ...
    var
        ...
        DisconnecionDateLbl: Label 'Disconnection Date';
