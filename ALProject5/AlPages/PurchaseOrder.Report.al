report 401 "Purchase Order"
{
    ...
    dataset
    {
        dataitem("Purchase Header"; "Purchase Header")
        {
            ...
            column(CompanyInfo1MawinguStamp; CompanyInfo1."Mawingu Stamp")
            {
            }
            column(CompanyInfo1ManagersSignature; CompanyInfo1."Managers Signature")
            {
            }
            ...
            dataitem(CopyLoop; "Integer")
            {
                ...
                dataitem(PageLoop; "Integer")
                {
                    ...
                    column(Mawingu_Stamp; CompanyInfo."Mawingu Stamp")
                    {
                    }
                    ...
                    trigger OnAfterGetRecord()
                    begin
                        CompanyInfo.CalcFields(CompanyInfo."Mawingu Stamp")
                    end;
            ...
            begin
                ...
                CompanyInfo1.CalcFields(CompanyInfo1.Picture, CompanyInfo1."Mawingu Stamp", CompanyInfo1."Managers Signature");
