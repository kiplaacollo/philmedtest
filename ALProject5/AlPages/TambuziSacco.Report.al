report 50433 "Tambuzi Sacco"
{
    DefaultLayout = RDLC;
    RDLCLayout = './TambuziSacco.rdlc';
    ...
    dataset
    {
        dataitem("Company Information"; "Company Information")
        {
            ...
            dataitem(pr_employees; pr_employees)
            {
                ...
                {
                    DataItemLink = "Customer No." = FIELD (st_no), "Posting Date" = FIELD ("Period Filter");
                    DataItemTableView = WHERE ("Transaction Type" = FILTER (Repayment));
