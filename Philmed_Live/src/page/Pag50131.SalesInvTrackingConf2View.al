page 50131 "Sales InvTracking Conf2 View"
{
    ApplicationArea = All;
    Caption = 'Sales InvTracking Conf2 View';
    PageType = List;
    ...
    layout
    {
        area(content)
        {
            repeater(General)
            {
                ...
                {
                    ApplicationArea = All;
                    ToolTip = 'Specifies the value of the Second Confirm. Time In field.';
                }
                field("Second Confirm. Time Out"; Rec."Second Confirm. Time Out")
                {
                    ApplicationArea = All;
                    ToolTip = 'Specifies the value of the Second Confirm. Time Out field.';
                }
                ...
                {
                    ApplicationArea = All;
                    ToolTip = 'Specifies the value of the Second Confirm. Executive field.';
                }
                field("Second Confirm. TAT (Mins)"; Rec."Second Confirm. TAT (Mins)")
                {
                    ApplicationArea = All;
                    ToolTip = 'Specifies the value of the Second Confirm. TAT (Mins) field.';
                }
            }
        }
    }
