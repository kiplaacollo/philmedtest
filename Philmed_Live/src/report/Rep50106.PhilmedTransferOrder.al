report 50106 "Philmed Transfer Order"
{
    DefaultLayout = RDLC;
    RDLCLayout = './PhilmedTransferOrder.rdlc';
    ...
    dataset
    {
        dataitem("Transfer Header"; "Transfer Header")
        {
            ...
            dataitem(CopyLoop; "Integer")
            {
                ...
                dataitem(PageLoop; "Integer")
                {
                    ...
                    dataitem("Transfer Line"; "Transfer Line")
                    {
                        ...
                        column(UnitCost; UnitCost)//AMI
                        {
                        }
                        column(LineCost; LineCost)//AMI
                        {
                        }
                        ...
                        begin
                            ...
                            lvItem.Get("Item No.");
                            UnitCost := lvItem."Unit Cost";
                            LineCost := UnitCost * "Quantity (Base)";
                        end;
                    }
                }
            ...
            begin
                ...
                if not UserSetup."Allow Printing Transfer Order" then
                    Error('You have Permission to Print Transfer Order Document');
    ...
    var
        ...
        UnitCost: Decimal;//AMI
        LineCost: Decimal;//AMI
