report 50104 "Inventory Profit Analysis"
{
    DefaultLayout = RDLC;
    RDLCLayout = './ProfitAnalysis.rdl';
    ApplicationArea = Basic, Suite;
    Caption = 'Inventory Profit Analysis';
    ...
    var
        ...
        InvCostAndPriceListCaptionLbl: Label 'Inventory Profit Analysis';
