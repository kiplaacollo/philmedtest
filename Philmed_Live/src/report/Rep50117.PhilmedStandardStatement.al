report 50117 "Philmed Standard Statement"
{
    RDLCLayout = './PhilmedStandardStatement.rdlc';

    Caption = 'Philmed Customer Statement';
    DefaultLayout = RDLC;
    ...
    dataset
    {
        dataitem(Customer; Customer)
        {
            ...
            column(PD_Cheques_Total; "PD Cheques Total")
            {
            }
