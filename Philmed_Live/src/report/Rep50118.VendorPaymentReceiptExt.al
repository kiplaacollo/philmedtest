report 50118 "Vendor - Payment Receipt Ext"
{
    DefaultLayout = RDLC;
    RDLCLayout = './PhilmedVendorPaymentReceipt.rdlc';
    Caption = 'Vendor - Payment Receipt Philmed';
    ...
    dataset
    {
        dataitem("Vendor Ledger Entry"; "Vendor Ledger Entry")
        {
            ...
            dataitem(PageLoop; "Integer")
            {
                ...
                column(ExternalDocNo_VendLedgEntry; "Vendor Ledger Entry"."External Document No.")
                {
                    //IncludeCaption = true;
                }
                ...
                dataitem(DetailedVendorLedgEntry1; "Detailed Vendor Ledg. Entry")
                {
                    ...
                    dataitem(VendLedgEntry1; "Vendor Ledger Entry")
                    {
                        ...
                        column(VendorInvoiceNo_VendLedgEntry1; "External Document No.")
                        {
                            IncludeCaption = true;
                        }
                ...
                dataitem(DetailedVendorLedgEntry2; "Detailed Vendor Ledg. Entry")
                {
                    ...
                    dataitem(VendLedgEntry2; "Vendor Ledger Entry")
                    {
                        ...
                        column(VendorInvoiceNo2_VendLedgEntry2; "External Document No.")
                        {
                        }
