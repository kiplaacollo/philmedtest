report 50127 "Philmed Sales - Credit Memo"
{
    RDLCLayout = './PhilmedStandardSalesCreditMemo.rdlc';
    ...
    dataset
    {
        dataitem(Header; "Sales Cr.Memo Header")
        {
            ...
            column(HideLetterHead; HideLetterHead)
            {
            ...
            begin
                ...
                HideLetterHead := lvCustomer."Cash Sale Customer";
