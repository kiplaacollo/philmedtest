table 50107 "Sales Invoice Tracking Entry"
{
    Caption = 'Sales Invoice Tracking Entry';
    ...
    fields
    {
        field(1; "Invoice No."; Code[20])
        {
            ...
            var
                ...
                lvSalesInvoiceLine: Record "Sales Invoice Line";
            Begin
                lvSalesInvoiceHeader.Get("Invoice No.");
                "Customer No." := lvSalesInvoiceHeader."Sell-to Customer No.";
                "Customer Name" := lvSalesInvoiceHeader."Sell-to Customer Name";
                "Posting Date" := lvSalesInvoiceHeader."Posting Date";
                "Branch Code" := lvSalesInvoiceHeader."Shortcut Dimension 1 Code";
                lvSalesInvoiceHeader.CalcFields("Amount Including VAT");
                "Amount Including VAT" := lvSalesInvoiceHeader."Amount Including VAT";
                "Route Plan" := lvSalesInvoiceHeader."Route Plan";
                //"Entry Time In" := CurrentDateTime;

                //No of Lines
                lvSalesInvoiceLine.Reset();
                lvSalesInvoiceLine.SetRange("Document No.", lvSalesInvoiceHeader."No.");
                lvSalesInvoiceLine.SetFilter("No.", '<>%1', '');
                if lvSalesInvoiceLine.FindSet() then
                    "No. of Lines" := lvSalesInvoiceLine.Count;
