report 50113 "Petty Cash Voucher"
{
    // version Funds Management Module v1.1.0

    DefaultLayout = RDLC;
    RDLCLayout = 'Petty Cash Voucher.rdl';
    ...
    dataset
    {
        dataitem("Payments Header"; "Payments Header")
        {
            ...
            column(Payments_Heade_Onbehalf; "On Behalf Of")
            {
            ...
            column(Payments_Header_Amount; "New Amount")
            {

            }
            column(Payments_Header_Net_Amount; "New Net Amount")
            {
            ...
            dataitem("Payment Line"; "Payment Line Table")
            {
                ...
                column(Payment_Line_PostingDate; "Date Posted")
                {
            ...
            begin
                ...
                //CheckReport.FormatNoText(NumberText,("Payments Header"."Net Amount"),'');
