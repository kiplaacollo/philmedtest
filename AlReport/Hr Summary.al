...
{
    DefaultLayout = RDLC;
    RDLCLayout = './Hr Summary Report.rdlc';
    ...
    dataset
    {
        dataitem(pr_employees;pr_employees)
        {
            ...
            column(SupervisorName_premployees;pr_employees."Supervisor Name")
            {
            }
            ...
            begin
                ...
                //ObjPayrollPeriods.SETRANGE(ObjPayrollPeriods.period_code,date filter);
                ...
                Transactions.SetRange(Transactions.period_code,ActivePeriod);
